    ...
    <div>
         <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-lg">
            ...
            <div className = "flex justify-between mt-10">
                <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo700 text-white font-bold uppercase rounded"
                onClick={() => setPaciente(paciente)}
                >
                    Editar
                </button>
                <button type="button" className="py-2 px-10 bg-red-600 hover:bg-indigo700 text-white font-bold uppercase rounded-lg"
